            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
              ...
              <div className="space-y-1.5">
                <div className="h-5 flex items-center justify-between">
                  ...
                  <Link
                    href="/teachers"
                    className="text-[11px] text-[#3f8ceb] hover:underline font-semibold inline-flex items-center gap-1"
                  >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-200/80">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="h-10 px-5 bg-[#29a71a] hover:bg-[#239217] text-white rounded-xl text-xs font-bold shadow-xs hover:shadow-sm hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2 cursor-pointer"
                        >
                          <img
                        ...
                        >
                          ...
                          <td className="py-3.5 px-4">
                            {slot.classroom ? (
                              ...
                              >
                                <img
                                  src={parseRoomBadge(slot.classroom).iconUrl}
                                  alt=""
                ...
                <div className="space-y-0.5">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {totalCollisionsCount === 0 ? (
                      <span className="text-[11px] font-bold text-emerald-700 bg-emerald-50 shadow-2xs px-2.5 py-0.5 rounded-full inline-flex items-center gap-1">
                        ✓ Bebas Pertembungan
                      </span>
                    ) : (
                      <span className="text-[11px] font-bold text-rose-700 bg-rose-50 shadow-2xs px-2.5 py-0.5 rounded-full inline-flex items-center gap-1">
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-100">
                        <div className="flex items-center gap-2.5 flex-wrap">
                          ...
                          {/* Room Category Badge */}
                          {isLab && (
                            <span className="inline-flex items-center gap-1.5 text-[10px] font-bold text-emerald-800 bg-emerald-50 border border-emerald-200/80 px-2 py-0.5 rounded-md">
                              <img src="/icons/makmal-komputer.png" alt="" className="w-3.5 h-3.5 object-contain shrink-0 inline-block" />
                              <span>Makmal: {slot.classroom || 'Makmal Asal'}</span>
                            </span>
                          )}
                          {isLecture && (
                            <span className="inline-flex items-center gap-1.5 text-[10px] font-bold text-indigo-800 bg-indigo-50 border border-indigo-200/80 px-2 py-0.5 rounded-md">
                              <img src="/icons/bilik-kuliah.png" alt="" className="w-3.5 h-3.5 object-contain shrink-0 inline-block" />
                              <span>Bilik Kuliah: {slot.classroom || 'Bilik Asal'}</span>
                            </span>
                          )}
                          {isOnline && (
                            <span className="inline-flex items-center gap-1.5 text-[10px] font-bold text-sky-800 bg-sky-50 border border-sky-200/80 px-2 py-0.5 rounded-md">
                              <img src="/icons/online.png" alt="" className="w-3.5 h-3.5 object-contain shrink-0 inline-block" />
                              <span>Atas Talian</span>
                            </span>
                          )}
                        </div>
                              ...
                              <td key={p.period} colSpan={span} className="p-0 align-top">
                                ...
                                >
                                  ...
                                  <div className="flex items-center justify-between gap-1">
                                    ...
                                    {hasConflict && (
                                      <span className="text-[8.5px] font-bold text-rose-700 bg-rose-100 shadow-2xs px-1.5 py-0.5 rounded shrink-0">
                                        ⚠️ Konflik
                                      </span>
                                    )}
                                  </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 border-b border-slate-100">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    className="h-10 px-4 bg-[#29a71a] hover:bg-[#239217] text-white rounded-xl text-xs font-bold shadow-xs hover:shadow-sm hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2 cursor-pointer"
                  >
                    <img
                      src="/icons/whatsapp.png"
                      alt="WhatsApp"
                    ...
                    {selectedMultiKeys.map((key, idx) => {
                      ...
                      return (
                        <tr key={key} className="hover:bg-slate-50/50 transition-colors">
                          ...
                          <td className="p-3">
                            <span
                              className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-bold shadow-2xs ${roomBadge.bgClass} ${roomBadge.textClass} truncate`}
                            >
                              <img src={roomBadge.iconUrl} alt="" className="w-3.5 h-3.5 object-contain shrink-0 inline-block" />
                              <span className="truncate">{roomBadge.code}</span>
                            </span>
                          </td>
                          <td className="p-3 text-center">
                            {hasConflict ? (
                              <span className="text-[10px] font-bold text-rose-700 bg-rose-50 shadow-2xs px-2.5 py-1 rounded-full whitespace-nowrap">
                                ⚠️ Konflik
                              </span>
                            ) : (
                              <span className="text-[10px] font-bold text-emerald-700 bg-emerald-50 shadow-2xs px-2.5 py-1 rounded-full whitespace-nowrap">
                                ✓ Sah
                              </span>
                            )}
                          </td>
